...
const FIELD_MAPPINGS = {
  ...
  medical: {
    disabilities: ["handicapts", "handicap", " Souffrez-vous d'un handicap?", "(Qui vous empêche de passer l'examen dans les mêmes conditions que tout le monde? Si oui, vous ne pouvez ",],
  },
  signature: [
    "signature",
    "veuillez signer",
  ...
  choices: {
    ...
    gender: ["genre"],
    sex: ["sexe"],
    examTypes: ["sujet d'examen", "sujet examen", "sujets d'examen", "sujets examen", "Épreuves",
			"Épreuves : sélectionnez toutes les épreuves",
		],
    examTypesFull: ["sujet d'examen", "sujet examen", "sujets d'examen", "sujets examen", "Épreuves",
			"Épreuves : sélectionnez toutes les épreuves",
		],
